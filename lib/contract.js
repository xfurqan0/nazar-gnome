...
//      it — the number is history and the panel says `?` instead. See `panelReading`; the
//      panel that sat on 67 % for four days after its weekly reset is why.
 ...
 * and only while that number can still be true.
 *
 ...
 * window closest to full cannot be trusted, the honest panel does not know how close to
 * full this machine is, and `?` is that sentence. Rule 2 again — never a reassuring 0 %,
 * and never a reassuring 5 % either.
 */
